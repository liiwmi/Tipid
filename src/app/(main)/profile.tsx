...
import {
  ...
  ScrollView, StyleSheet, Alert, ActivityIndicator, Image,
} from 'react-native';
...
export default function ProfileScreen() {
  ...
  const handleSave = async () => {
    ...
    await saveProfile({ displayName, email, phone, region, avatarUri });
    setIsDirty(false);
    ...
    <SafeAreaView edges={['top', 'bottom', 'left', 'right']} style={[s.safe, { backgroundColor: colors.bgSecondary }]}>
      <ScrollView contentContainerStyle={s.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={s.header}>
          ...
          <Text style={[s.pageTitle, { color: colors.textPrimary }]}>My Profile</Text>
          <View style={{ width: 24 }} />
        </View>
        ...
        <View style={s.avatarSection}>
          <TouchableOpacity onPress={pickImage} style={s.avatarWrapper}>
            {avatarUri ? (
              ...
              <View style={[s.avatarFallback, { backgroundColor: colors.bgListIcon }]}>
        ...
        {/* PERSONAL INFO */}
        <Text style={[s.sectionLabel, { color: colors.textSecondary }]}>PERSONAL INFO</Text>
        <View style={cardStyle}>
          ...
          <View style={[s.row, rowBorder]}>
            ...
            <View style={s.rowBody}>
              <Text style={[s.rowLabel, { color: colors.textSecondary }]}>Display Name</Text>
              <TextInput
          ...
          <View style={[s.row, { borderBottomWidth: 0 }]}>
            ...
            <View style={s.rowBody}>
              <Text style={[s.rowLabel, { color: colors.textSecondary }]}>Phone</Text>
              <TextInput
                style={[s.rowInput, { color: colors.textPrimary }]}
                value={phone}
        ...
        {/* REGION */}
        <Text style={[s.sectionLabel, { color: colors.textSecondary }]}>REGION</Text>
        <View style={cardStyle}>
          <View style={[s.row, { borderBottomWidth: 0 }]}>
            <View style={[s.rowIcon, { backgroundColor: colors.bgListIcon }]}>
            ...
            <View style={s.rowBody}>
              <Text style={[s.rowLabel, { color: colors.textSecondary }]}>Grid Region</Text>
            ...
            {REGIONS.map((r) => (
              <TouchableOpacity
                ...
                style={[
                  ...
                  region === r && { backgroundColor: colors.primary, borderColor: colors.primary },
                ]}
                onPress={() => { setRegion(r); markDirty(); }}
              >
                <Text style={[
                  s.regionText,
