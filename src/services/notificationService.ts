...
export async function checkAndFireNotifications(
  ...
  projectedMinutesRemaining: number | null = null, // NEW PARAMETER
): Promise<void> {
  if (isExpoGo) return;
  ...
  // ── 2. 90% THRESHOLD (EXISTING, NOW WITH PROJECTED TIME) ──
